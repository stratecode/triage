...
class TestJiraClientInit:
    ...
    def test_init_sets_base_url(self):
        ...
        client = JiraClient(base_url="https://test.atlassian.net", email="test@example.com", api_token="test-token")
    ...
    def test_init_sets_project_filter(self):
        ...
        client = JiraClient(
            base_url="https://test.atlassian.net", email="test@example.com", api_token="test-token", project="PROJ"
        )
...
class TestFetchActiveTasks:
    ...
    def test_fetch_active_tasks_auth_error(self, mock_request):
        ...
        client = JiraClient(base_url="https://test.atlassian.net", email="test@example.com", api_token="invalid-token")
    ...
    def test_fetch_active_tasks_with_project_filter(self, mock_request):
        ...
        client = JiraClient(
            base_url="https://test.atlassian.net", email="test@example.com", api_token="test-token", project="MYPROJ"
        )
...
class TestJiraClientErrorHandling:
    ...
    def test_rate_limiting_with_retry_after_header(self, mock_request):
        ...
        client = JiraClient(
            base_url="https://test.atlassian.net", email="test@example.com", api_token="test-token", max_retries=2
        )
    ...
    def test_invalid_jql_query_error(self, mock_request):
        ...
        mock_response.json.return_value = {"errorMessages": ['Field "invalid_field" does not exist']}
    ...
    def test_timeout_retry_logic(self, mock_sleep, mock_request):
        ...
        mock_request.side_effect = [requests.exceptions.Timeout("Request timed out"), mock_response_200]
    ...
    def test_connection_error_retry_logic(self, mock_sleep, mock_request):
        ...
        mock_request.side_effect = [requests.exceptions.ConnectionError("Failed to connect"), mock_response_200]
    ...
    def test_auth_error_no_retry(self, mock_request):
        ...
        client = JiraClient(
            base_url="https://test.atlassian.net", email="test@example.com", api_token="invalid-token", max_retries=3
        )
